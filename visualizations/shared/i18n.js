...
i18nRegister({
  'en': {
    ...
    'nav.cat.mlfoundations': 'ML Foundations',
    'nav.topic.23': 'Embeddings',
    'nav.topic.24': 'Tokenization',
    'nav.topic.25': 'Training & Loss',
    'nav.topic.26': 'Quantization',
    'nav.topic.27': 'LoRA Fine-tuning',
    'nav.topic.28': 'Decoding Strategies',
    // Progress
  ...
  'zh-CN': {
    ...
    'nav.topic.21': '知识图谱构建',
    'nav.topic.22': 'CAG vs RAG',
    'nav.cat.mlfoundations': '机器学习基础',
    'nav.topic.23': '嵌入向量',
    'nav.topic.24': '分词器',
    'nav.topic.25': '训练与损失',
    'nav.topic.26': '量化',
    'nav.topic.27': 'LoRA 微调',
    'nav.topic.28': '解码策略',
    // Progress
  ...
  'zh-TW': {
    ...
    'nav.topic.21': '知識圖譜構建',
    'nav.topic.22': 'CAG vs RAG',
    'nav.cat.mlfoundations': '機器學習基礎',
    'nav.topic.23': '嵌入向量',
    'nav.topic.24': '分詞器',
    'nav.topic.25': '訓練與損失',
    'nav.topic.26': '量化',
    'nav.topic.27': 'LoRA 微調',
    'nav.topic.28': '解碼策略',
    // Progress
